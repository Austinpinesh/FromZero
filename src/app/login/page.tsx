                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full h-14 mt-2 bg-[#20c997] hover:bg-[#18a077] text-white font-bold rounded-full transition-all shadow-lg shadow-[#20c997]/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {loading ? (
                                <>
                    ...
                    <p className="text-center text-gray-500 text-sm mt-6">
                        ...
                        <Link href="/signup" className="text-[#20c997] font-semibold hover:underline">
                            Sign up
                        </Link>
                    </p>
                </div>
